    ...
    <>
      <div className="flex flex-col items-center py-12 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
          {/* Single Card Section */}
          <div className="bg-white p-6 rounded-lg shadow-lg border flex flex-col justify-between h-full">
            <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border flex flex-col justify-between h-full">
            ...
            <button
              ...
              className="mt-6 bg-blue-600 text-black w-full py-2 rounded-md border-2 border-blue-700 hover:bg-blue-700"
            >
              View Bundles
            </button>
          </div>
      ...
      <div
        ref={bundlesRef}
        className="flex flex-col items-center py-12 bg-gray-50"
      >
        <h1 className="text-3xl font-semibold mb-6 text-gray-800">
          Pricing and Card Bundles
        </h1>
