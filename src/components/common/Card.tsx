...
// }, [selectedCategory, router]);
  ...
  return (
    <div style={{ padding: '50px', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}>
      ...
      We have Group Greeting Cards for all occasions<strong style={{ textDecoration: 'underline', color: '#000' }}> Premium cards</strong>  start at<strong style={{ textDecoration: 'underline', color: '#000' }}> $1</strong>
      </h1>
