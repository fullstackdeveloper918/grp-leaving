...
export const GooglePayWithCDN = (props: any) => {
    ...
    const tokenizationSpecification = {
        ...
        parameters: {
            ...
            "stripe:publishableKey": process.env.NEXT_PUBLIC_STAGING_STRIPE_KEY as string,
        },
    };
    ...
    const [isGooglePayButtonAppended, setIsGooglePayButtonAppended] = useState(false);
    ...
    useEffect(() => {
        ...
        return () => {
            const scripts = document.querySelectorAll('script[src="https://pay.google.com/gp/p/js/pay.js"]');
